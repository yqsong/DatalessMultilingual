 ...
 */
public class PanLexJSONParser3Digits {
    ...
    public final Map<Integer, String> languageTags = new HashMap<>();

    // Indices
    private Map<Integer, List<Models.Wc>> wordClassByDn;
    private Map<Integer, List<Models.Df>> definitionByMeaning;

    private final static Logger log = LogManager.getLogger(PanLexJSONParser3Digits.class);

    public PanLexJSONParser3Digits(PanLexDir dir) {
        this.dir = dir;
    ...
    private void populateLanguageTags() {
        ...
        for (int i : varieties.keySet()) {
        	String lvStr = varieties.get(i).lc;
            threeToTwo.put(lvStr, lvStr);
        }
