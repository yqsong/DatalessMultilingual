...
//		testSimpleConcepts ("", "english", "topdown", 1);
	...
	public static void testSimpleConcepts(String embeddingSource, String lgName, String direction, int topK) {
		...
		if (lgName.equals("english")) {
			...
			docIDContentConceptFile = "/home/data/corpora/rcv2/output/" + embeddingSource + "/" + lgName + ".rcv2.esa.concepts.500";
			treeConceptFile = "/home/data/corpora/rcv2/output/" + embeddingSource + "/" + lgName + ".tree.rcv2.esa.concepts.500";
