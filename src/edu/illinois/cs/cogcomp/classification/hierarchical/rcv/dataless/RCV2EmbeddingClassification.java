...
//		}
	...
	public static void testSimpleConcepts(String embeddingSource, String lgName, String direction, int topK) {
		...
		if (lgName.equals("english")) {
			docIDContentConceptFile = "/shared/shelley/yqsong/data/rcv2/output/" + lgName + ".rcv1.esa.concepts.500";
			treeConceptFile = "/shared/shelley/yqsong/data/rcv2/output/" + lgName + ".tree.rcv1.esa.concepts.500";
			...
			docIDContentConceptFile = "/shared/shelley/yqsong/data/rcv2/output/" + embeddingSource + "/" + lgName + ".rcv2.esa.concepts.500";
			treeConceptFile = "/shared/shelley/yqsong/data/rcv2/output/" + embeddingSource + "/" + lgName + ".tree.rcv2.esa.concepts.500";
			docIDTopicMapFile = "/shared/shelley/yqsong/data/rcv2/output/" + embeddingSource + "/" + lgName + ".rcv2.labels";
			outputClassificationFile = "/shared/shelley/yqsong/data/rcv2/output/results." + lgName + ".supervised.classification";
			outputLabelComparisonFile = "/shared/shelley/yqsong/data/rcv2/output/results." + lgName + ".supervised.labelComparison";
		}
