...
public class DumpEmbeddinhData {
...
//		}
	...
	public static void dumptCorpusEmbedding (int id, String embeddingSource, String outputFolder) 	{
		...
		int conceptNum = 500;
		String outputData = outputFolder + embeddingSource + "/" + lgName + ".rcv2.esa.concepts." + conceptNum;
	...
	public static void rcvDumpTreeData (int id, String embeddingSource, String outputFolder) {
		...
		int conceptNum = 500;
		String outputData = outputFolder + embeddingSource + "/" + lgName + ".tree.rcv2.esa.concepts." + conceptNum;
