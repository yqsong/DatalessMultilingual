...
//		HashMap<String, String> availability = EmbeddingLanguages.ted_availability;
		...
		} else if (resource.equals("euro")) {
			outputFolder = "/shared/shelley/yqsong/data/tedcldc/output.embedding-euro-sim/";
		} else if (resource.equals("muse")) {
			outputFolder = "/home/data/corpora/tedcldc/output.embedding-muse-sim/";
		}
...
//			double f1;
//			try {
//				f1 = testOneLabel (12, j, false, resource, outputFolder);
//				f1List.add(f1);
//			} catch (Exception e) {
...
//		}
//		for (int j = 0; j < TEDData.labelNameArray.length; ++j) {
//			System.out.println("[Summary] " + "\t" + TEDData.lgNameArray[12] + "\t" + TEDData.labelNameArray[j] + "\t" + f1List.get(j));
//		}
	}
