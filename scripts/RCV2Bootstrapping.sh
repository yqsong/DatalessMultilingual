...
nice java -Xmx30g -cp ${CLASSPATH} edu.illinois.cs.cogcomp.classification.hierarchical.rcv.dataless.RCV2Bootstrapping
#we have to increase memory to 80G for german