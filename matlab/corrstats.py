...
print dependent_corr(0.9604, 0.9072, 0.8942, 39, True, 0.95, 'steiger')
#print dependent_corr(0.9604, 0.9072, 0.8942, 39, True, 0.95, 'zou')

print dependent_corr(0.7797, 0.8560, 0.6192, 39, True, 0.95, 'steiger')
print dependent_corr(0.8560, 0.8528, 0.8442, 39, True, 0.95, 'steiger')
print dependent_corr(0.7797, 0.9072, 0.7208, 39, True, 0.95, 'steiger')
print dependent_corr(0.8560, 0.9072, 0.8431, 39, True, 0.95, 'steiger')
